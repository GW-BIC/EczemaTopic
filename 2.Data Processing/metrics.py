...
def binary_classification_summary(y, y_predicted,y_score,title):
    ...
    classification_summary = pd.DataFrame([acc, sen, spe, auc], index = ["Accuracy", "Sensitivity", "Specificity", "AUROC"], columns = [title])
